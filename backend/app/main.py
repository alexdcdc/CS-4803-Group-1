...
from app.routers import auth, comments, feed, mux_webhooks, projects, stripe_webhooks, users, wallet
...
app.include_router(comments.router, prefix="/api/v1/videos", tags=["comments"])
